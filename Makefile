#############################################################################
# Makefile for building: oilminer-qt
# Generated by qmake (2.01a) (Qt 4.8.5) on: p� 1. 8 09:49:59 2014
# Project:  oilminer-qt.pro
# Template: app
# Command: c:\Qt\4.8.5\bin\qmake.exe USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile oilminer-qt.pro
#############################################################################
...
Makefile: oilminer-qt.pro  ../Qt/4.8.5/mkspecs/default/qmake.conf ../Qt/4.8.5/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile oilminer-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/oilminer/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/oilminer/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/oilminer/src/leveldb/libleveldb.a: FORCE
